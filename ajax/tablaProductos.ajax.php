...
class TablaProductos
{
    ...
    public function mostrarTablaProductos()
    {
        ...
        for ($i = 0; $i < count($productos); $i++) {
            ...
            $imagen = "<img width='100' src='".$productos[$i]['imagen_producto']."'>";
            //Traemos las acciones
            $acciones = 
            "<button type='button' id_producto = ". $productos[$i]["id_producto"] . "' class='btn btn-icon btn-light-info btnImprimirProducto'><i class='fas fa-file-archive'></i></button>".
            "<a type='button' class='btn btn-icon btn-light-warning btnBoton'  href = 'index.php?pagina=editar-producto&id_producto=" 
            . $productos[$i]["id_producto"] . "' ><i class='fas fa-pen'></i></a> <button type='button' id_producto = '". $productos[$i]["id_producto"] . "' class='btn btn-icon btn-light-danger btnEliminarProducto'><i class='fas fa-trash-alt'></i></button>";
